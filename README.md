...
The YOLO PC sends annotated JPEG frames and status values to the Railway backend. The frontend reads video from `/video_feed` and status/chart values from `/api/status` and `/ws/viewer`.
